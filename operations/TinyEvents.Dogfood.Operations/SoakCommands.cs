...
internal static class SoakCommands
{
    public static async Task<int> PublishAsync(string[] args, DogfoodSettings settings)
    {
        ...
        {
            Console.Error.WriteLine("Expected publish-soak <seconds:1-259200> <rate:20-2000,multiple-of-20> <window-seconds:1-10> <new-output.jsonl>.");
            return 1;
        }
    ...
    public static async Task<int> WorkAsync(string[] args, DogfoodSettings settings)
    {
        ...
        {
            Console.Error.WriteLine("Expected worker-soak <unique-worker-id>.");
            return 1;
        }
